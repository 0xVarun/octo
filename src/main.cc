...
class MainRestController : public octo::service::RestController {
public:
    MainRestController() {}
};
...
int main(int argc, char **argv) {
    MainRestController m;
    auto* instance = octo::internal::State::getInstance();
    octo::internal::State::registerRoute("/", m);
}
